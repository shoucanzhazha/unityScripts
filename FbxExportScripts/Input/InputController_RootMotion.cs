...
//     version 1.3.0
//     from Assets/Scripts/Input/InputController_RootMotion.inputactions
//
...
public partial class @InputController_RootMotion : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputController_RootMotion()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputController_RootMotion"",
    ""maps"": [
        {
            ""name"": ""PlayerInput"",
    ...
    {
        private @InputController_RootMotion m_Wrapper;
        public PlayerInputActions(@InputController_RootMotion wrapper) { m_Wrapper = wrapper; }
